window.publicationsData = {
  ...
  "papers": [
    ...
    },
    {
      ...
      "abstract": "Contemporary research on collective memory recognises the past’s dynamic role in present conflicts and future possibilities. Yet in a time of polycrisis marked by resurgent authoritarianism, rising individualism, democratic backsliding, and withdrawal from political participation, much work on collective memory remains descriptive and treats groups as homogeneous units. This article advances Genetic Social Psychology as an interdisciplinary framework for examining how collective memory, understood as social representations, is transformed through relationships of domination, submission, and cooperation. These relationship qualities shape not only what groups remember but also how memories change or remain continuous across microgenesis, ontogenesis, and sociogenesis. Drawing on Piaget, Bartlett, Moscovici, and Gerard Duveen, the article argues for attention to heterogeneity within antagonistic groups and to the developmental mechanisms through which collective memories may support conflict transformation.",
    ...
    },
    {
      ...
      "abstract": "Although the study of social cohesion in divided and post-conflict societies has grown within social psychology, addressing social cohesion remains complex because it is multidimensional and multilevel. This special issue introduction advances understanding of the dynamics of social cohesion across contexts marked by deep social divisions and intergroup tensions, where achieving cohesion is particularly challenging. It showcases research examining different dimensions of social cohesion and explores how such analyses can inform efforts to foster cohesion and improve intra- and intergroup relations. Bringing together empirical articles using quantitative and qualitative methods in diverse divided and post-conflict contexts, the article highlights how identities, narratives, trust, belonging, participation, and institutional arrangements shape social cohesion.",
      "pdf": "papers/figueiredo-et-al-2025-social-cohesion-in-post-conflict-and-divided-societies-recent-advances.pdf"
    },
    {
      "year": 2024,
      "authors": "Christiana Karayianni and Charis Psaltis",
      "title": "Social media networks and the networks of meanings",
      "abstract": "The article investigates images in communication processes as manifestations of social representations. Focusing on the conflict-affected society of Cyprus, it studies the images used in 76,250 tweets related to the Cyprus problem during the intensification of the negotiations between September 2016 and July 2017. Through social network visualisation, it identifies the most prominent images used to construct meaning about the Cyprus problem, as well as the clusters created through image tweeting. The results show that many images tweeted about the Cyprus problem are institutionalised manifestations of social representations that do not necessarily support the peace process. Instead, they reinforce a social imaginary in which Cyprus is shaped by repeated unsuccessful peace efforts, distant from grassroots society, and by the expectation that a solution will arrive as an external force from political elites.",
      "pdf": "papers/karayianni-psaltis-2024-social-media-networks-and-the-networks-of-meanings.pdf"
    },
    {
      "year": 2023,
    ...
    },
    {
      ...
      "abstract": "This study examines a teacher-led intervention that created contact between primary school children and a puppet presented as a Syrian refugee child. Using a pre-post quasi-experimental design with a control group, retest, and late-response test, the intervention aimed to create contact conditions between children and a puppet classmate holding the identity of a Syrian refugee child. Contact with a puppet is treated as an innovative form of contact combining features of direct and indirect intergroup contact. The sample included 73 primary school students from a relatively ethnically homogeneous school in Athens, and the study used attitude measures and a behavioral money-allocation task. Results showed that contact with the puppet improved children’s attitudes toward refugees through inclusion of the other in the self, increased empathy, and reduced threat-related feelings. The most favorable effects appeared in the intervention condition that combined contact and empathy-inducing activities with the puppet.",
    ...
    },
    {
      ...
      "abstract": "Positive attitudes and trust toward former adversaries facilitate reconciliation and peacebuilding. This article examines how historical and current intergroup experiences, including contact and conflict, jointly predict intergroup attitudes and trust among inhabitants of former mixed villages in Cyprus. Drawing on social representations theory and using a multilevel design, the study highlights the importance of both individual and collective experiences. It examines the effects of positive intergroup contact before conflict, negative experiences of conflict, and positive intergroup contact after conflict. The analysis shows that present-day attitudes are shaped by the interplay between remembered coexistence, collective conflict experiences, and current forms of contact, underlining that reconciliation depends on both personal encounters and shared representations of the past.",
    ...
    },
    {
      "year": 2020,
      "authors": "Charis Psaltis",
      "title": "The internally displaced in Cyprus and Return Intentions",
      "abstract": "A large-scale, representative sample survey of the two main communities of Cyprus (Greek Cypriot and Turkish Cypriot) was undertaken five months after the failure of negotiations at Crans-Montana, with several objectives. First among these was the aim to gather infor- mation on citizen views regarding the Cyprus issue and intercommunal relations. Second, the study aimed to learn the communities’ ideas for a possible solution, while also consid- ering the role of various demographic variables (age, gender, educational level, IDP status) and the quality of intercommunal relations (intercommunal contact, realistic and symbolic threats, prejudice, trust) in relation to the wish for renewed cohabitation. A particular focus of the survey was to record the views of internally displaced persons (IDP), especially their reasons/intention to return and their reasons for not returning, with the obje...",
      "pdf": "papers/psaltis-2020-the-internally-displaced-in-cyprus-and-return-intentions.pdf"
    },
    {
      "year": 2019,
    ...
    },
    {
      ...
      "abstract": "This edited volume brings together social psychological, educational, and historical perspectives on the role of history education in conflict transformation. It examines how school history, collective memory, official narratives, and historical representations can either sustain division or support reconciliation. The volume argues that history teaching in post-conflict and divided societies should move beyond the transmission of single national narratives and cultivate multiperspectivity, historical thinking, dialogue, and critical engagement with the past. Through theoretical chapters and empirical case studies, it shows how history education can become a site for democratic learning, recognition of the other, and peacebuilding.",
      "pdf": "papers/psaltis-et-al-2017-history-education-and-conflict-transformation.pdf"
    },
    {
      "year": 2017,
      "authors": "Shelley McKeown and Charis Psaltis",
      "title": "Intergroup Contact and the Mediating Role of Intergroup Trust",
      "abstract": "Intergroup contact is well established as a route to prejudice reduction, and positive contact can increase trust and improve attitudes between groups in conflict. This article examines intergroup contact, intergroup trust, and future contact intentions in Cyprus and Northern Ireland. Participants completed an online survey reporting contact experiences, intergroup trust, outgroup evaluation, and intentions for future contact. Separate models were tested for Protestants and Catholics in Northern Ireland and for Greek Cypriots and Turkish Cypriots in Cyprus. Results showed that contact was more frequent and of higher quality in Northern Ireland than in Cyprus. For Protestants, Catholics, and Greek Cypriots, contact quality, more than contact quantity, predicted future contact intentions and improved attitudes through intergroup trust. For Turkish Cypriots, contact quality also directly predicted outgroup evaluation. The article highlights the importance of positive contact quality in segregated societies while also showing that contextual and group-status differences matter.",
      "pdf": "papers/mckeown-psaltis-2017-intergroup-contact-and-the-mediating-role-of-intergroup-trust.pdf"
    },
    {
      "year": 2017,
      "authors": "Charis Psaltis et al",
    ...
    },
    {
      "year": 2016,
      "authors": "Charis Psaltis",
      "title": "Collective Memory Social Representations of Intercommunal Relations",
      "abstract": "This paper discusses a line of research on social representations of the Cyprus issue, its history, and intercommunal relations among Greek Cypriots and Turkish Cypriots. It focuses on official historical narratives and their relation to social representations of intercommunal relations, especially as expressed in oral history accounts of former inhabitants of mixed villages. These inhabitants have living memories of intercommunal habitation before the war of 1974 and the geographical division of Cyprus. The paper frames these findings through interdisciplinary discussions between historians and social psychologists on collective memory, social representations, and conflict transformation. It argues that remembering the past in Cyprus is shaped by official narratives, identity positions, contact, trust, threat, and hopes for future coexistence.",
      "pdf": "papers/psaltis-2016-collective-memory-social-representations-of-intercommunal-relations.pdf"
    },
    {
      "year": 2016,
      "authors": "Charis Psaltis",
      "title": "Representations of the Past and Collective Memory",
      "abstract": "This paper examines collective memory and social representations of intercommunal relations in divided Cyprus. It reviews findings from research on how Greek Cypriots and Turkish Cypriots represent the Cyprus issue, its history, and relations between the two communities. Particular attention is given to oral history accounts of former inhabitants of mixed villages, whose memories of pre-1974 coexistence are shaped by official histories, community narratives, and present-day identities. The paper argues that collective memory is not a neutral record of the past but a socially organized field of meanings that influences trust, threat, forgiveness, and openness to conflict transformation. It situates these findings within wider debates between history, social psychology, and social representations theory.",
      "pdf": "papers/psaltis-charis-2016-representations-of-the-past-and-collective-memory.pdf"
    },
    {
      "year": 2016,
    ...
    },
    {
      "year": 2012,
      "authors": "Charis Psaltis",
      "title": "Culture and Heterogeneity",
      "abstract": "In this commentary on Jahoda (2012) and Moghaddam (2012), I discuss the problem of the reification of culture from a social representations perspective and argue that social representations as a notion overcomes many of the shortcomings of the notion of culture, the main being reification. Whilst building this argument I show, by making reference to recent developments in the field of social representations and social devel- opmental psychology, how weaknesses in social representations theory identified by Jahoda (1988) were addressed and how insights from this approach can be used for diversity management policies in education.",
      "pdf": "papers/psaltis-2012-culture-and-heterogeneity.pdf"
    },
    {
      "year": 2012,
      "authors": "Charis Psaltis",
    ...
    },
    {
      ...
      "abstract": "Although intergroup contact is one of the most prominent interventions for reducing prejudice, the generalization of contact effects remains contested. This article examines the secondary transfer effect, by which contact with a primary outgroup reduces prejudice toward secondary groups not directly involved in the contact. Across cross-sectional studies in Cyprus, Northern Ireland, and Texas, and a longitudinal study in Northern Ireland, the research rules out alternative explanations and investigates two mediating mechanisms: ingroup reappraisal and attitude generalization. Results show that contact with a primary outgroup predicts attitudes toward secondary outgroups above and beyond contact with those secondary groups and social desirability. The findings advance contact theory by showing how positive contact can generalize beyond the immediate intergroup context.",
