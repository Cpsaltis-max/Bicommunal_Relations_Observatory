window.publicationsData = {
  ...
  "papers": [
    ...
    },
    {
      ...
      "abstract": "Global Perspectives on the Role of Dialogue in History Education Socio- cultural, Psychological, and Digital Dimensions Edited by Mario Carretero and Everardo Perez-Manjarrez First published 2025 ISBN: 978-1-032-85440-3 (hbk) ISBN: 978-1-003-53589-8 (ebk) Chapter 3 Contested history teaching and dialogue in divided Cyprus Charis Psaltis, Meltem Onurkan-Samani, Marina Kyprianou, and Hasan Samani (CC-BY-NC-ND 4.0) DOI: 10.4324/9781003535898-5 DOI: 10.4324/9781003535898-5 3 Contested history teaching and dialogue in divided Cyprus* Charis Psaltis, Meltem Onurkan- Samani, Marina Kyprianou, and Hasan Samani Heritage and history Numerous scholars have evaluated the diverse methods through which history education, particularly at the school level, is approached. Lowenthal’s (1998) differentiation between “heritage” and “history” holds particular relevance in the context of Cyprus, where histori...",
    ...
    },
    {
      ...
      "abstract": "Correspondence should be addressed to: christiana.k@gmail.com x.1 Papers on Social Representations Early Access (2024) Peer Reviewed Online Journal ISSN 1021-5573 © 2024 Karayianni Christiana & Psaltis Charis. [http://psr.iscte-iul.pt/index.php/PSR/index] Social media networks and the networks of meanings as imaginings of the Cyprus problem: A study on the use of images on Twitter in the Cyprus peace efforts CHRISTIANA KARAYIANNI1, CHARIS PSALTIS2 1 Frederick University, Nicosia, Cyprus. 2 University of Cyprus, Nicosia, Cyprus. The article investigates images in communication processes as manifestations of social representations. Focusing on the conflict -affected society of Cyprus, it studies the images used in 76250 tweets related to the Cyprus problem during the intensification of the negotiations in the period between September 2016 – July 2017. Through social network visualisation w...",
    ...
    },
    {
      ...
      "abstract": "Peace and Conflict: Journal of Peace Psychology Role of Honor, Dignity, and Face Values in Transitional Justice in Postconflict Cyprus Charis Psaltis, Alexander Kirchner-Häusler, Ayse K. Uskul, Iosif Kovras, and Androulla Eleftheriou Online First Publication, March 30, 2023. https://dx.doi.org/10.1037/pac0000665 CITATION Psaltis, C., Kirchner-Häusler, A., Uskul, A. K., Kovras, I., & Eleftheriou, A. (2023, March 30). Role of Honor, Dignity, and Face Values in Transitional Justice in Postconflict Cyprus. Peace and Conflict: Journal of Peace Psychology . Advance online publication. https://dx.doi.org/10.1037/pac0000665 Role of Honor, Dignity, and Face Values in Transitional Justice in Postcon ﬂict Cyprus Charis Psaltis 1, Alexander Kirchner-H äusler2, Ayse K. Uskul 2, Iosif Kovras 3, and Androulla Eleftheriou 1 1 Department of Psychology, University of Cyprus 2 School of Psychology, Univers...",
    ...
    },
    {
      ...
      "abstract": "How can areas of potential agreement be identi ﬁed and endorsed by citizens in protracted con ﬂicts?In an effort to answer this question, the article introduces a conjoint experiment across the ethnically and territorially split communities of Cyprus and tests a range of hypotheses about the structure of public opinion with respect to a future settlement. We test hypotheses on security and credible commitments, the legacy of past negotiations, as well as transitional justice mechanisms following United Nations plans to mediate the con ﬂict between Greek and Turkish Cypriots. Contrary to conventional wisdom, we demonstrate that a zone of possible agreement (ZOPA) exists from a public opinion perspective. We speci ﬁcally explore power-sharing in the context of security, provisions for the internally displaced, federal courts, and terri- torial readjustments and highlight their relative imp...",
    ...
    },
    {
      ...
      "abstract": "COST is supported by the EU Framework Programme Horizon 2020 Recommendations for the History Teaching of Intergroup Conflicts 01 I How do we teach the history of intergroup conflicts? The way recent and old intergroup conflicts are presented around the world1 in curricula, textbooks, civil society and social representations can be characterised by four main approaches. In the first approach, a moratorium is imposed and any reference to the conflictual past is avoided; the second is a selective approach where nation-states or groups keep silent about aspects that involve wrongdoing of one’s own group, here called “ingroup”, and offer either a positive presentation of the “ingroup” or a preservation of the memory of the conflict by reiterating master narratives of one-sided victimisation of the “ingroup”. Both of these approaches are highly problematic as they become an obstacle to conflic...",
    ...
    },
    {
      ...
      "abstract": "Peace and Conflict: Journal of Peace Psychology Intergroup Contact and the Mediating Role of Intergroup Trust on Outgroup Evaluation and Future Contact Intentions in Cyprus and Northern Ireland Shelley Mc Keown and Charis Psaltis Online First Publication, July 13, 2017. http://dx.doi.org/10.1037/pac0000275 CITATION Mc Keown, S., & Psaltis, C. (2017, July 13). Intergroup Contact and the Mediating Role of Intergroup Trust on Outgroup Evaluation and Future Contact Intentions in Cyprus and Northern Ireland. Peace and Conflict: Journal of Peace Psychology . Advance online publication. http://dx.doi.org/10.1037/pac0000275 Intergroup Contact and the Mediating Role of Intergroup Trust on Outgroup Evaluation and Future Contact Intentions in Cyprus and Northern Ireland Shelley Mc Keown University of Bristol Charis Psaltis University of Cyprus It is well supported that intergroup contact reduces pr...",
    ...
    },
    {
      ...
      "abstract": "Collective Memory, Social Representations of Intercommunal Relations, and Conflict Transformation in Divided Cyprus Charis Psaltis University of Cyprus The paper discusses the main findings of a line of research that explored the social representations of the Cyprus issue and its history as well as intercommunal relations by Greek Cypriots and Turkish Cypriots in the divided country of Cyprus. It focuses on the role of official historical narratives and their relation to social representations of intercommunal relations in Cyprus as manifested in oral history accounts of former inhabitants of mixed villages. Such inhabitants have living memories of intercommunal habitation before the war of 1974 and the geographical division of Cyprus by the Turkish army that year. These research findings are framed in the context of emerging interdisciplinary theoretical discussions between historians a...",
    ...
    },
    {
      ...
      "abstract": "5 Genetic Social Psychology: From Microgenesis to Ontogenesis, Sociogenesis ... and Back Charis Psaltis Introduction As recently argued by Valsiner (2013, p. ix), psychology is in deep crisis because of its success in amassing large quantities of empirical evidence but rarely addressing the question “What for?” Valsiner refers to the life work of the late Gerard Duveen as “a good illustration of what kind of scholarship could bring psychology out of its crisis of limited generaliza- tion value”, even going so far as to state that genetic social psychology, is “the idea that will live” (Valsiner, 2013, p. ix). Moscovici (2010) states that the work of Duveen inspired some of his writings (see Moscovici, 1990), and that Duveen “had been able to raise fundamental epistemo- logical questions and to propose some elements of answer on which we must reﬂect further” (p.2.4). Duveen’s vision of ge...",
    ...
    },
    {
      ...
      "abstract": "Oral history accounts of the former inhabitants of mixed villages in Cyprus A social representations perspective ABSTRACT HERE 1. History and social psychology: Beyond the individual-social antinomy In a dialogue gaining momentum between historians and social psychologists (Knights 2012) it was recently suggested that bridges between the two disciplines can be built by taking the following themes as points of connection: the nature of modernity, collective memory and the uses of the past, political discourse and ideologies, partisanship, the public sphere, and languages and images. One could argue that oral history is in a privileged position to engage all these issues at once due to its particularity to stand at the interface between the individual and society and in the nexus of the past, present and future. This is exactly the same focus as Serge Moscovici’s Social Representations The...",
    ...
    },
    {
      ...
      "abstract": "See discussions, stats, and author profiles for this publication at: https://www.researchgate.net/publication/233413403 History Teaching in Cyprus. In E. Erdmann & W. Hasberg Chapter · January 2011 CITATION 1 READS 632 2 authors, including: Some of the authors of this publication are also working on these related projects: Hostory Educators beliefs and practices in Cyprus View project Social Representations of Gender, Social Interaction and Cognitive Development View project Charis Psaltis University of Cyprus 65 PUBLICATIONS 1,288 CITATIONS SEE PROFILE All content following this page was uploaded by Charis Psaltis on 16 November 2016. The user has requested enhancement of the downloaded file. Cyprus History Teaching in Cyprus Chara Makriyianni and Charis Psaltis and Dilek Latif* 1. Historical culture 1.1. History in the public / public history and predominant dialogues in media and poli...",
